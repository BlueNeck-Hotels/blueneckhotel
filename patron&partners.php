            ...
            <div class="col-12 col-md-6 col-lg-6">
                <div data-aos="fade-up" data-aos-duration="3000" data-aos-offset="200">
                    <h1 class="font_size_47 h1_size text-white contact-padding-top text-capitalize">
                        <span class="yellow">patron & partners</span>
                    </h1>
                    <div class="row mashine_top">
                        ...
                        Let's become partners and shine with one of the best entry-level three-star boutique hotels in Gurugram.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                            ...
                            <div class="d-flex form-border py-2 my-4">
                                ...
                                <input type="email" class="form-control ps-2" id="exampleInputPassword1"
                                    placeholder="Email" required>
                            </div>
                            <div class="d-flex form-border py-2">
                                <img src="./assets/font/call-form.svg" alt="" class="img-fluid ps-2">
                                <input type="tel" class="form-control ps-2" id="exampleInputPassword1"
