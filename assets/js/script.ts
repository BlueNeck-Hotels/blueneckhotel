...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const tomorrow: Date = new Date(today.getTime() + 24 * 60 * 60 * 1000); // Get tomorrow's date
  ...
  document.getElementById("datepickerIconSecond")?.addEventListener("click", function () {
    checkOutPicker.open();
  });
  ...
  function updateCheckoutDate(): void {
  ...
  document.querySelector('.carsour-pointer.minus')?.addEventListener("click", minus);
  document.querySelector('.carsour-pointer.plus')?.addEventListener("click", plus);
...
//   });
  
   {
    ...
    roomCroses?.addEventListener("click", () => {
...
function validateForm() {
  ...
  const mobileNumberInput = document.getElementById('NumberValidata') as HTMLInputElement;
  const termsCheckbox = document.getElementById('termsCheckbox') as HTMLInputElement;
  const paymentSelect = document.getElementById('floatingSelect') as HTMLSelectElement;
  const formFour = document.getElementById("form4");
  const formFive = document.getElementById("form5");
  const checkBoxThree = document.getElementById("check-box-three");
  const textColor = document.getElementById("text-color");
