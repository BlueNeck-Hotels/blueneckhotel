            ...
            <div class="col-12 col-md-6 col-lg-6">
                <div data-aos="fade-up" data-aos-duration="3000" data-aos-offset="200">
                    <h1 class="font_size_47 h1_size text-white contact-padding-top text-capitalize">
                        <span class="yellow">Jobs@BlueNeck</span>
                    </h1>
                    <div class="row mashine_top">
                        ...
                        We would like to work with you if you are passionate and can perform your role exceptionally well.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="d-flex form-border py-2">
                                ...
                                <input type="text" class="form-control ps-2" id="exampleInputPassword1"
                                    placeholder="Name">
                            </div>
                            <div class="d-flex form-border py-2 my-4">
                                <img src="./assets/font/message-form.svg" alt="" class="img-fluid ps-2">
                                <input type="email" class="form-control ps-2" id="exampleInputPassword-one"
                                    placeholder="Email" required>
                            </div>
                            <div class="d-flex form-border py-2">
                                <img src="./assets/font/call-form.svg" alt="" class="img-fluid ps-2">
                                <input type="tel" class="form-control ps-2" id="exampleInputPassword1-two"
                                    placeholder="Phone" required>
                            </div>
                        </div>
                        <div class="col-5 form-border">
                            <input type="text" class="form-control" id="exampleInputPassword-three"
